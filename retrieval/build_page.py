...
.nb.samelog img{border-color:var(--warn);border-style:dashed;}
...
<div class="controls">
  ...
  <span class="note" style="margin-left:auto">green border = same driving command as the query
  &middot; amber dashed = same log</span>
</div>
